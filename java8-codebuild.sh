...
sam_package eu-central-1 ${EU_CENTRAL_1_ARTIFACT_BUCKET} java8-generator
sam_package eu-west-1 ${EU_WEST_1_ARTIFACT_BUCKET} java8-generator
sam_package eu-west-2 ${EU_WEST_2_ARTIFACT_BUCKET} java8-generator
sam_package eu-west-3 ${EU_WEST_3_ARTIFACT_BUCKET} java8-generator
